 ...
 *
 * @see com.cnqaos.hibernate.pojo.Subject
...
public class SubjectDAO extends BaseHibernateDAO {
    ...
    public Subject findById(java.lang.Integer id) {
        ...
        try {
            Subject instance = (Subject) getSession().get(
                    "com.cnqaos.hibernate.pojo.Subject", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByExample(Subject instance) {
        ...
        try {
            List results = getSession()
                    .createCriteria("com.cnqaos.hibernate.pojo.Subject")
    ...
    public List<Subject> findBySubjectIds(String subjectIds) {
        ...
        try {
            ...
            log.error("find by subjectIds failed", re);
            throw re;
        }
    }
